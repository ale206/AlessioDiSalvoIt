...
(function() {
    ...
    t.kc = function(a, c) {
        ...
        t.Hb(d.D) && (delete d.D, delete d.Y, delete d.disabled);
        t.Hb(d) && t.Gc(a);
    };
    t.qc = function(a) {
        function c() { return f; }
    ...
    function u(a, c, d, e) { t.ic.forEach(d, function(d) { a(c, d, e); }); }
    ...
    t.e = function(a, c) {
        ...
        t.h.Z(c, function(a, c) { -1 !== a.indexOf("aria-") || "role" == a ? d.setAttribute(a, c) : d[a] = c; });
        return d;
    };
    ...
    t.h.Z = function(a, c, d) { for (var e in a)v.call(a, e) && c.call(d || this, e, a[e]); };
    t.h.A = function(a, c) {
        if (!c)return a;
    ...
    t.h.od = function(a, c) {
        var d, e, g;
        a = t.h.copy(a);
        for (d in c)v.call(c, d) && (e = a[d], g = c[d], a[d] = t.h.Ta(e) && t.h.Ta(g) ? t.h.od(e, g) : c[d]);
        return a;
    };
    t.h.copy = function(a) { return t.h.A({}, a); };
    ...
    t.me = /Chrome/i.test(t.M);
    t.ec = !!("ontouchstart" in window || window.Vc && document instanceof window.Vc);
    t.Ic = function(a, c) { t.h.Z(c, function(c, e) { e === k || "undefined" === typeof e || e === l ? a.removeAttribute(c) : a.setAttribute(c, e === f ? "" : e); }); };
    t.Aa = function(a) {
        var c, d, e, g;
        c = {};
    ...
    t.he = function() { document.onselectstart = r(f); };
    ...
    t.get = function(a, c, d, e) {
        ...
        j.protocol + j.host !== n.protocol + n.host && window.XDomainRequest && !("withCredentials" in
            h) ? (h = new window.XDomainRequest, h.onload = function() { c(h.responseText); }, h.onerror = d, h.onprogress = m(), h.ontimeout = d) : (g = "file:" == j.protocol || "file:" == n.protocol, h.onreadystatechange = function() { 4 === h.readyState && (200 === h.status || g && 0 === h.status ? c(h.responseText) : d(h.responseText)); });
        try {
    ...
    t.qa = {};
    t.qa.Lb = function(a, c) {
        var d, e, g;
        a = t.h.copy(a);
        for (d in c)c.hasOwnProperty(d) && (e = a[d], g = c[d], a[d] = t.h.Ta(e) && t.h.Ta(g) ? t.qa.Lb(e, g) : c[d]);
        return a;
    };
    t.a = t.ra.extend({
        i: function(a, c, d) {
    ...
    s.c = f;
    s.j = p("c");
    s.options = function(a) { return a === b ? this.l : this.l = t.qa.Lb(this.l, a); };
    ...
    s.w = p("b");
    s.ja = function() { return this.v || this.b; };
    s.id = p("U");
    s.name = p("Hd");
    s.children = p("N");
    s.yd = function(a) { return this.Qa[a]; };
    s.ka = function(a) { return this.Ra[a]; };
    s.R = function(a, c) {
        var d, e;
    ...
    s.removeChild = function(a) {
        ...
        if (a && this.N) {
            ...
            c && (this.Qa[a.id] = k, this.Ra[a.name] = k, (c = a.w()) && c.parentNode === this.ja() && this.ja().removeChild(a.w()));
        }
    };
    s.vc = function() {
        var a, c, d, e;
        ...
        if (c = this.options().children)
            if (t.h.isArray(c))for (var g = 0; g < c.length; g++)d = c[g], "string" == typeof d ? (e = d, d = {}) : e = d.name, a[e] = a.R(e, d);
            else t.h.Z(c, function(c, d) { d !== l && (a[c] = a.R(c, d)); });
    };
    s.T = r("");
    s.d = function(a, c) {
    ...
    function E(a) { a.q("vjs-lock-showing"); }
    ...
    s.rd = function(a, c) { return this.width(a, f).height(c); };
    ...
    s.e = function(a, c) {
        ...
        c.innerHTML || (this.v = t.e("div", { className: "vjs-control-content" }), this.xb = t.e("span", { className: "vjs-control-text", innerHTML: this.s(this.ua) || "Need Text" }), this.v.appendChild(this.xb), d.appendChild(this.v));
        return d;
    };
    s.T = function() { return"vjs-control " + t.a.prototype.T.call(this); };
    s.r = m();
    s.Ya = function() { t.d(document, "keyup", t.bind(this, this.ea)); };
    s.ea = function(a) { if (32 == a.which || 13 == a.which)a.preventDefault(), this.r(); };
    s.Xa = function() { t.p(document, "keyup", t.bind(this, this.ea)); };
    t.Q = t.a.extend({
        i: function(a, c) {
            t.a.call(this, a, c);
            ...
            this.S = {};
            this.S.move = t.bind(this, this.$a);
    ...
    t.I.prototype.e = function(a, c) { return t.t.prototype.e.call(this, "li", t.h.A({ className: "vjs-menu-item", innerHTML: this.l.label }, c)); };
    t.I.prototype.r = function() { this.selected(f); };
    t.I.prototype.selected = function(a) { a ? (this.n("vjs-selected"), this.b.setAttribute("aria-selected", f)) : (this.q("vjs-selected"), this.b.setAttribute("aria-selected", l)); };
    t.L = t.t.extend({
        i: function(a, c) {
            t.t.call(this, a, c);
            this.Ba = this.xa();
    ...
    s.xa = function() {
        ...
        this.options().title && a.ja().appendChild(t.e("li", { className: "vjs-menu-title", innerHTML: t.ba(this.options().title), ee: -1 }));
        if (this.O = this.createItems())for (var c = 0; c < this.O.length; c++)ca(a, this.O[c]);
        return a;
    };
    s.wa = m();
    s.T = function() { return this.className + " vjs-menu-button " + t.t.prototype.T.call(this); };
    s.Ya = m();
    s.Xa = m();
    s.r = function() {
    ...
    t.F = function(a) {
        ...
        this.message || (this.message = t.F.pd[this.code] || "");
    };
    ...
    if (N) {
        t.Pa.Eb = {};
        for (O = 0; O < N.length; O++)t.Pa.Eb[M[O]] = N[O];
    }
    t.Player = t.a.extend({
        i: function(a, c, d) {
            this.P = a;
            ...
            t.Ca[this.U] = this;
            c.plugins && t.h.Z(c.plugins, function(a, c) { this[a](c); }, this);
            var e, g, h, j, n, q;
            ...
            this.d("keydown", e);
            this.d("keyup", e);
            h = setInterval(t.bind(this, function() { this.pa && (this.pa = l, this.userActive(f), clearTimeout(j), j = setTimeout(t.bind(this, function() { this.pa || this.userActive(l); }), 2E3)); }), 250);
    ...
    s.e = function() {
        ...
        d = t.Aa(c);
        t.h.Z(d, function(c) { a.setAttribute(c, d[c]); });
        c.id += "_html5_api";
    ...
    function P(a, c, d) {
        a.k && (a.la = l, a.k.dispose(), a.k = l);
        "Html5" !== c && a.P && (t.g.Bb(a.P), a.P = k);
        a.eb = c;
        a.la = l;
        ...
        a.k.J(function() { this.c.Ga(); });
    }

    s.Md = function() {
        this.error(k);
        this.paused() ? (Q(this, l), this.X("play", function() { Q(this, f); })) : this.m("firstplay");
    };
    s.uc = l;

    function Q(a, c) { c !== b && a.uc !== c && ((a.uc = c) ? (a.n("vjs-has-started"), a.m("firstplay")) : a.q("vjs-has-started")); }

    s.Ob = function() {
        this.q("vjs-paused");
        this.n("vjs-playing");
    };
    s.Sd = function() { this.n("vjs-waiting"); };
    s.Rd = function() { this.q("vjs-waiting"); };
    s.Pd = function() { this.n("vjs-seeking"); };
    s.Od = function() { this.q("vjs-seeking"); };
    s.Kd = function() {
    ...
    s.Nd = function() { 1 == this.bufferedPercent() && this.m("loadedalldata"); };
    s.Id = function() { this.l.loop && (this.currentTime(0), this.play()); };
    s.Ac = function() {
        var a = R(this, "duration");
        a && (0 > a && (a = Infinity), this.duration(a), Infinity === a ? this.n("vjs-live") : this.q("vjs-live"));
    };
    s.Ld = function() { this.isFullscreen() ? this.n("vjs-fullscreen") : this.q("vjs-fullscreen"); };

    function S(a, c, d) {
        if (a.k && !a.k.la)a.k.J(function() { this[c](d); });
        else
            try {
                a.k[c](d);
            } catch (e) {
    ...
    s.currentTime = function(a) { return a !== b ? (S(this, "setCurrentTime", a), this) : this.G.currentTime = R(this, "currentTime") || 0; };
    ...
    s.volume = function(a) {
        if (a !== b)return a = Math.max(0, Math.min(1, parseFloat(a))), this.G.volume = a, S(this, "setVolume", a), t.Yd(a), this;
        a = parseFloat(R(this, "volume"));
        return isNaN(a) ? 1 : a;
    };
    s.muted = function(a) { return a !== b ? (S(this, "setMuted", a), this) : R(this, "muted") || l; };
    s.Ea = function() { return R(this, "supportsFullScreen") || l; };
    s.wc = l;
    s.isFullscreen = function(a) { return a !== b ? (this.wc = !!a, this) : this.wc; };
    ...
    s.exitFullscreen = function() {
        ...
        else this.k.Ea() ? S(this, "exitFullScreen") : (this.Cb(), this.m("fullscreenchange"));
        return this;
    };
    s.pc = function() {
        this.Bd = f;
    ...
    s.rc = function(a) { 27 === a.keyCode && (this.isFullscreen() === f ? this.exitFullscreen() : this.Cb()); };
    s.Cb = function() {
        this.Bd = l;
    ...
    s.src = function(a) {
        ...
        t.h.isArray(a) ? T(this, a) : "string" === typeof a ? this.src({ src: a }) : a instanceof Object && (a.type && !window.videojs[this.eb].canPlaySource(a) ? T(this, [a]) : (this.G.src = a.src, this.nc = a.type || "", this.J(function() {
            S(this, "src", a.src);
    ...
    function T(a, c) {
        ...
        a: {
            d = 0;
            for (var e = a.l.techOrder; d < e.length; d++) {
                ...
                } else t.log.error('The "' + g + '" tech is undefined. Skipped browser support check for that tech.');
            }
            d = l;
        }
        d ? d.k === a.eb ? a.src(d.source) : P(a, d.k, d.source) : (a.error({ code: 4, message: a.options().notSupportedMessage }), a.Ga());
    }
    ...
    s.nd = function() { return this.nc || ""; };
    s.Da = function(a) { return a !== b ? (S(this, "setPreload", a), this.l.preload = a, this) : R(this, "preload"); };
    s.autoplay = function(a) { return a !== b ? (S(this, "setAutoplay", a), this.l.autoplay = a, this) : R(this, "autoplay"); };
    s.loop = function(a) { return a !== b ? (S(this, "setLoop", a), this.l.loop = a, this) : R(this, "loop"); };
    s.poster = function(a) {
    ...
    s.controls = function(a) { return a !== b ? (a = !!a, this.yb !== a && ((this.yb = a) ? (this.q("vjs-controls-disabled"), this.n("vjs-controls-enabled"), this.m("controlsenabled")) : (this.q("vjs-controls-enabled"), this.n("vjs-controls-disabled"), this.m("controlsdisabled"))), this) : this.yb; };
    t.Player.prototype.Tb;
    s = t.Player.prototype;
    s.usingNativeControls = function(a) { return a !== b ? (a = !!a, this.Tb !== a && ((this.Tb = a) ? (this.n("vjs-using-native-controls"), this.m("usingnativecontrols")) : (this.q("vjs-using-native-controls"), this.m("usingcustomcontrols"))), this) : this.Tb; };
    s.da = k;
    s.error = function(a) {
    ...
    s.playbackRate = function(a) { return a !== b ? (S(this, "setPlaybackRate", a), this) : this.k && this.k.o && this.k.o.playbackRate ? R(this, "playbackRate") : 1; };
    t.Ja = t.a.extend();
    t.Ja.prototype.l = { pe: "play", children: { playToggle: {}, currentTimeDisplay: {}, timeDivider: {}, durationDisplay: {}, remainingTimeDisplay: {}, liveDisplay: {}, progressControl: {}, fullscreenToggle: {}, volumeControl: {}, muteToggle: {}, playbackRateMenuButton: {} } };
    t.Ja.prototype.e = function() { return t.e("div", { className: "vjs-control-bar" }); };
    ...
    s = t.ac.prototype;
    s.ua = "Play";
    s.T = function() { return"vjs-play-control " + t.t.prototype.T.call(this); };
    ...
    t.gc.prototype.e = function() { return t.a.prototype.e.call(this, "div", { className: "vjs-time-divider", innerHTML: "<div><span>/</span></div>" }); };
    t.pb = t.a.extend({
        i: function(a, c) {
            t.a.call(this, a, c);
            a.d("timeupdate", t.bind(this, this.ga));
    ...
    t.pb.prototype.ga = function() { this.c.duration() && (this.v.innerHTML = '<span class="vjs-control-text">' + this.s("Remaining Time") + "</span> -" + t.za(this.c.remainingTime())); };
    t.Ka = t.t.extend({ i: function(a, c) { t.t.call(this, a, c); } });
    t.Ka.prototype.ua = "Fullscreen";
    t.Ka.prototype.T = function() { return"vjs-fullscreen-control " + t.t.prototype.T.call(this); };
    t.Ka.prototype.r = function() { this.c.isFullscreen() ? (this.c.exitFullscreen(), this.xb.innerHTML = this.s("Fullscreen")) : (this.c.requestFullscreen(), this.xb.innerHTML = this.s("Non-Fullscreen")); };
    t.ob = t.a.extend({ i: function(a, c) { t.a.call(this, a, c); } });
    t.ob.prototype.l = { children: { seekBar: {} } };
    ...
    s = t.cc.prototype;
    s.l = { children: { loadProgressBar: {}, playProgressBar: {}, seekHandle: {} }, barName: "playProgressBar", handleName: "seekHandle" };
    s.Cc = "timeupdate";
    s.e = function() { return t.Q.prototype.e.call(this, "div", { className: "vjs-progress-holder", "aria-label": "video progress bar" }); };
    s.oa = function() {
        var a = this.c.bb ? this.c.G.currentTime : this.c.currentTime();
    ...
    t.$b.prototype.e = function() { return t.a.prototype.e.call(this, "div", { className: "vjs-play-progress", innerHTML: '<span class="vjs-control-text"><span>' + this.s("Progress") + "</span>: 0%</span>" }); };
    t.Ma = t.$.extend({
        i: function(a, c) {
            t.$.call(this, a, c);
            a.d("timeupdate", t.bind(this, this.ga));
    ...
    t.Ma.prototype.e = function() { return t.$.prototype.e.call(this, "div", { className: "vjs-seek-handle", "aria-live": "off" }); };
    ...
    t.rb = t.a.extend({
        i: function(a, c) {
            ...
            a.d("loadstart", t.bind(this, function() { a.k.o && a.k.o.volumeControl === l ? this.n("vjs-hidden") : this.q("vjs-hidden"); }));
        }
    });
    t.rb.prototype.l = { children: { volumeBar: {} } };
    ...
    s.Cc = "volumechange";
    s.e = function() { return t.Q.prototype.e.call(this, "div", { className: "vjs-volume-bar", "aria-label": "volume level" }); };
    s.$a = function(a) {
    ...
    t.hc = t.a.extend({ i: function(a, c) { t.a.call(this, a, c); } });
    t.hc.prototype.e = function() { return t.a.prototype.e.call(this, "div", { className: "vjs-volume-level", innerHTML: '<span class="vjs-control-text"></span>' }); };
    t.sb = t.$.extend();
    t.sb.prototype.defaultValue = "00:00";
    t.sb.prototype.e = function() { return t.$.prototype.e.call(this, "div", { className: "vjs-volume-handle" }); };
    t.ia = t.t.extend({
        i: function(a, c) {
            t.t.call(this, a, c);
    ...
    t.sa = t.L.extend({
        i: function(a, c) {
            ...
            a.d("loadstart", t.bind(this, function() { a.k.o && a.k.o.Sc === l ? this.n("vjs-hidden") : this.q("vjs-hidden"); }));
            this.n("vjs-menu-button");
        }
    });
    t.sa.prototype.xa = function() {
        var a = new t.ha(this.c, { lc: "div" }), c = new t.qb(this.c, t.h.A({ vertical: f }, this.l.ve));
        a.R(c);
        return a;
    };
    ...
    t.sa.prototype.e = function() { return t.t.prototype.e.call(this, "div", { className: "vjs-volume-menu-button vjs-menu-button vjs-control", innerHTML: '<div><span class="vjs-control-text">' + this.s("Mute") + "</span></div>" }); };
    ...
    s.xa = function() {
        ...
        if (c)for (var d = c.length - 1; 0 <= d; d--)a.R(new t.nb(this.j(), { rate: c[d] + "x" }));
        return a;
    };
    s.oa = function() { this.w().setAttribute("aria-valuenow", this.j().playbackRate()); };
    s.r = function() {
    ...
    function U(a) { return a.j().k && a.j().k.o.playbackRate && a.j().options().playbackRates && 0 < a.j().options().playbackRates.length; }

    s.Rc = function() { U(this) ? this.q("vjs-hidden") : this.n("vjs-hidden"); };
    s.Qc = function() { U(this) && (this.yc.innerHTML = this.j().playbackRate() + "x"); };
    t.nb = t.I.extend({
        lc: "button",
        i: function(a, c) {
    ...
    t.nb.prototype.update = function() { this.selected(this.j().playbackRate() == this.Fc); };
    t.La = t.t.extend({
        i: function(a, c) {
            t.t.call(this, a, c);
    ...
    t.La.prototype.r = function() { this.j().controls() && this.c.play(); };
    t.Zb = t.a.extend({ i: function(a, c) { t.a.call(this, a, c); } });
    t.Zb.prototype.e = function() { return t.a.prototype.e.call(this, "div", { className: "vjs-loading-spinner" }); };
    t.fb = t.t.extend();
    ...
    t.jb.prototype.update = function() { this.j().error() && (this.v.innerHTML = this.s(this.j().error().message)); };
    t.u = t.a.extend({
        i: function(a, c, d) {
            c = c || {};
            c.Hc = l;
            ...
            this.o.progressEvents || (this.zc = f, this.Ec = setInterval(t.bind(this, function() {
                ...
                this.jd != a && this.j().m("progress");
                this.jd = a;
                1 === a && clearInterval(this.Ec);
            }), 500));
            this.o.timeupdateEvents || (this.Kb = f, this.j().d("play", t.bind(this, this.Pc)), this.j().d("pause", t.bind(this, this.cb)), this.X("timeupdate", function() {
            ...
            this.J(function() { this.networkState && 0 < this.networkState() && this.j().m("loadstart"); });
        }
    });
    s = t.u.prototype;
    s.Wd = function() {
    ...
    s.Pc = function() {
        this.mc && this.cb();
        this.mc = setInterval(t.bind(this, function() { this.j().m("timeupdate"); }), 250);
    };
    s.cb = function() {
    ...
    t.g = t.u.extend({
        i: function(a, c, d) {
            ...
            a.J(function() { this.P && (this.l.autoplay && this.paused()) && (delete this.P.poster, this.play()); });
            this.Ga();
        }
    });
    s = t.g.prototype;
    ...
    s.e = function() {
        ...
        if (!c || this.o.movingMediaElementInDOM === l)c ? (d = c.cloneNode(l), t.g.Bb(c), c = d, a.P = k) : (c = t.e("video"), t.Ic(c, t.h.A(a.fe || {}, { id: a.id() + "_html5_api", "class": "vjs-tech" }))), c.player = a, t.Gb(c, a.w());
    ...
    s.ud = function(a) { "error" == a.type ? this.j().error(this.error().code) : (a.bubbles = l, this.j().m(a)); };
    ...
    s.ce = function(a) { this.b.volume = a; };
    s.muted = function() { return this.b.muted; };
    s.$d = function(a) { this.b.muted = a; };
    s.width = function() { return this.b.offsetWidth; };
    s.height = function() { return this.b.offsetHeight; };
    s.Ea = function() { return"function" == typeof this.b.webkitEnterFullScreen && (/Android/.test(t.M) || !/Chrome|Mac OS X 10.5/.test(t.M)) ? f : l; };
    s.oc = function() {
        var a = this.b;
    ...
    s.ae = function(a) { this.b.playbackRate = a; };
    ...
    t.g.Bc = function() {
        4 <= t.Ub && (V || (V = t.B.constructor.prototype.canPlayType), t.B.constructor.prototype.canPlayType = function(a) { return a && ga.test(a) ? "maybe" : V.call(this, a); });
        t.bd && (V || (V = t.B.constructor.prototype.canPlayType), t.B.constructor.prototype.canPlayType = function(a) { return a && ha.test(a) ? "maybe" : V.call(this, a); });
    };
    t.g.ie = function() {
    ...
    t.f = t.u.extend({
        i: function(a, c, d) {
            ...
            var e = c.source;
            d = c.parentEl;
            var g = this.b = t.e("div", { id: a.id() + "_temp_flash" }), h = a.id() + "_flash_api", j = a.l, j = t.h.A({ readyFunction: "videojs.Flash.onReady", eventProxyFunction: "videojs.Flash.onEvent", errorEventProxyFunction: "videojs.Flash.onError", autoplay: j.autoplay, preload: j.Da, loop: j.loop, muted: j.muted }, c.flashVars), n = t.h.A({ wmode: "opaque", bgcolor: "#000000" }, c.params), h = t.h.A({ id: h, name: h, "class": "vjs-tech" }, c.attributes);
            e && (e.type && t.f.Dd(e.type) ?
            (e = t.f.Nc(e.src), j.rtmpConnection = encodeURIComponent(e.wb), j.rtmpStream = encodeURIComponent(e.Rb)) : j.src = encodeURIComponent(t.sc(e.src)));
            t.Gb(g, d);
            ...
            t.Xc && this.J(function() { t.d(this.w(), "mousemove", t.bind(this, function() { this.j().m({ type: "mousemove", bubbles: l }); })); });
            a.d("stageclick", a.reportUserActivity);
            this.b = t.f.td(c.swf, g, j, n, h);
        }
    });
    t.f.prototype.dispose = function() { t.u.prototype.dispose.call(this); };
    ...
    t.f.prototype.src = function(a) {
        ...
        t.f.Cd(a) ? (a = t.f.Nc(a), this.re(a.wb), this.se(a.Rb)) : (a = t.sc(a), this.b.vjs_src(a));
        if (this.c.autoplay()) {
            var c = this;
    ...
    t.f.vb = function(a) {
        ...
        if (a in t.f.xd || a in t.f.Oc)return"maybe";
    };
    t.f.xd = { "video/flv": "FLV", "video/x-flv": "FLV", "video/mp4": "MP4", "video/m4v": "MP4" };
    ...
    t.f.checkReady = function(a) { a.w() && (a.w().vjs_getProperty ? a.Ga() : setTimeout(function() { t.f.checkReady(a); }, 50)); };
    t.f.onEvent = function(a, c) { t.w(a).player.m(c); };
    ...
    t.f.Dd = function(a) { return a in t.f.Oc; };
    t.f.dd = /^rtmp[set]?:\/\//i;
    t.f.Cd = function(a) { return t.f.dd.test(a); };
    t.cd = t.a.extend({
        i: function(a, c, d) {
            t.a.call(this, a, c, d);
    ...
    t.Player.prototype.textTracks = function() { return this.Fa = this.Fa || []; };
    ...
    function ma(a, c, d, e, g) {
        ...
        h.push(j);
        j.Ab() && a.J(function() { setTimeout(function() { Y(j.j(), j.id()); }, 0); });
    }
    ...
    t.C = t.a.extend({
        i: function(a, c) {
            ...
            this.tb = [];
            this.ma = this.na = 0;
            this.c.d("fullscreenchange", t.bind(this, this.fd));
        }
    });
    s = t.C.prototype;
    s.K = p("H");
    ...
    s.readyState = p("na");
    s.mode = p("ma");
    s.fd = function() { this.b.style.fontSize = this.c.isFullScreen() ? 140 * (screen.width / this.c.width()) + "%" : ""; };
    s.e = function() { return t.a.prototype.e.call(this, "div", { className: "vjs-" + this.H + " vjs-text-track" }); };
    s.show = function() {
        na(this);
        this.ma = 2;
    ...
    s.load = function() { 0 === this.na && (this.na = 1, t.get(this.Kc, t.bind(this, this.Td), t.bind(this, this.Jd))); };
    s.Jd = function(a) {
        this.error = a;
        this.na = 3;
        this.m("error");
            ...
            if (this.Pb === b || a < this.Pb || this.Wa <= a) {
                ...
                for (;;) {
                    ...
                    if (q.ya <= a)e = Math.max(e, q.ya), q.Oa && (q.Oa = l);
                        ...
                        g ? (h.splice(0, 0, q), n === b && (n = w), j = w) : (h.push(q), j === b && (j = w), n = w), d = Math.min(d,
    ...
    t.fc.prototype.e = function() { return t.a.prototype.e.call(this, "div", { className: "vjs-text-track-display" }); };
    t.aa = t.I.extend({
        i: function(a, c) {
    ...
    t.aa.prototype.update = function() { this.selected(2 == this.fa.mode()); };
    t.mb = t.aa.extend({
        i: function(a, c) {
            c.track = { K: function() { return c.kind; }, j: a, label: function() { return c.kind + " off"; }, Ab: r(l), mode: r(l) };
            t.aa.call(this, a, c);
            this.selected(f);
        }
    });
    ...
    t.V.prototype.wa = function() {
        var a = [], c;
        a.push(new t.mb(this.c, { kind: this.H }));
    ...
    s.xa = function() {
        ...
        a = this.Ba;
        a === b && (a = new t.ha(this.c), a.ja().appendChild(t.e("li", { className: "vjs-menu-title", innerHTML: t.ba(this.H), ee: -1 })));
        if (g) {
            e = g.ca;
            for (var j, c = 0, d = e.length; c < d; c++)j = e[c], j = new t.gb(this.c, { track: g, cue: j }), h.push(j), a.R(j);
            this.R(a);
        }
    ...
    t.ub = function() { setTimeout(t.jc, 1); };
    "complete" === document.readyState ? t.Tc = f : t.X(window, "load", function() { t.Tc = f; });
    t.ub();
    t.Vd = function(a, c) { t.Player.prototype[a] = c; };
    var pa = this;
    ...
    t.u.prototype.o.fullscreenResize = t.u.prototype.o.ne;
    t.u.prototype.o.progressEvents = t.u.prototype.o.qe;
    t.u.prototype.o.timeupdateEvents = t.u.prototype.o.te;
    ...
    t.g.unpatchCanPlayType = t.g.ie;
    t.g.prototype.setCurrentTime = t.g.prototype.Qb;
    t.g.prototype.setVolume = t.g.prototype.ce;
    t.g.prototype.setMuted = t.g.prototype.$d;
    t.g.prototype.setPreload = t.g.prototype.be;
    t.g.prototype.setAutoplay = t.g.prototype.Xd;
    t.g.prototype.setLoop = t.g.prototype.Zd;
    t.g.prototype.enterFullScreen = t.g.prototype.oc;
    t.g.prototype.exitFullScreen = t.g.prototype.vd;
    t.g.prototype.playbackRate = t.g.prototype.playbackRate;
    t.g.prototype.setPlaybackRate = t.g.prototype.ae;
    $("videojs.Flash", t.f);
    ...
    t.C.prototype.cues = t.C.prototype.md;
