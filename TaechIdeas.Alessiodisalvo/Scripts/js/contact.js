...
jQuery(document).ready(function($) {
    ...
    jQuery('#st-container').load('/' + GetCultureFromUrl() + '/Home/Nav', function() {
        //Begin: MailChimp JS
...
new stepsForm(theForm, {
    onSubmit: function(form) {
        ...
        $.post('/' + culture + '/Contact/SubmitEmail', $("#theForm").serialize(),
            function(data) {
                ...
                if (data == "True") {
                    ...
                    if (culture == "it") {
                        message = "Grazie! Ti risponderò al più presto";
                    }
